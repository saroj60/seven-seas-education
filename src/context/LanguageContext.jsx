  ...
  EN: {
    ...
    tests: {
      ...
      nat: {
        ...
        desc: "The NAT-TEST is an examination that measures the Japanese language ability of individuals who are not native Japanese speakers.",
  ...
  NE: {
    ...
    tests: {
      ...
      nat: {
        ...
        desc: "NAT-TEST एक परीक्षा हो जसले गैर-जापानी वक्ताहरूको जापानी भाषा क्षमता मापन गर्दछ।",
